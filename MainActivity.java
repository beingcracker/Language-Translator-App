...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"From","English","Marathi","Arabic","Belarusian","Bulgarian","Bengali","Catalan","Czech","Welsh","Hindi","Urdu"};
    String[] toLanguages = {"To","English","Marathi","Arabic","Belarusian","Bulgarian","Bengali","Catalan","Czech","Welsh","Hindi","Urdu"};
